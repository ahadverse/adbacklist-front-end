  ...
  return (
    <div>
      ...
      <div className="w-11/12 m-auto pt-10 sm:w-5/6">
        <h1 className="text-xl font-bold sm:text-3xl text-white">Terms</h1>
        <hr />
        <br />
        <strong>
        ...
        <p>
          ...
          mining instrument, software or routine to gain access, copy, or obtain
          any part of the Website unless expressly permitted by the Website;
        </p>
        <br />
        <p>
          12. Gaining or trying to obtain unauthorized accessibility to non
          public regions of the website. In addition, if you Own a password into
          a Non Public Subject of the Site, you may not disclose to, or discuss
          with your password, either with any third parties or even utilize your
          password to unauthorized purposes;
        </p>
        <br />
        <p>
          13. Attempting to decipher, decompile, disassemble or reverse engineer
          any of the software comprising or in any way creating all or any part
          of the Site; altering any meta data, copying or duplicating in any
          manner any of these articles; framing of or linking to any of the
          Site, its content or data accessible from the Site without the express
          written consent of representatives of the Website;
        </p>
        <br />
        <p>
          14. Discriminating on the Basis of race, religion, national origin,
          sex, handicap, age, marital status, sexual orientation, or refers to
          such matters in any manner prohibited by legislation ;
        </p>
        <br />
        <p>
          15. Posting any job ads separating the anti-discrimination conditions
          of the Immigration and Nationality Act or messages which violate any
          law or law, or any advertising which violate labor regulation of the
          country.
        </p>
        <br />
        <p>
          16. Using the site in order to engage in or assist another person or
          entity to take part in fraudulent, abusive, manipulative or illegal
          activity.
        </p>
        <br />
        <p>
          17. Posting Totally Free ads promoting links to commercial providers
          or web sites except in areas of the Website in which these
          advertisements are explicitly permitted;
        </p>
        <br />
        <p>
          18. Putting up any material advertisements firearms that the use,
          carrying, or advertising which is prohibited by applicable national,
          state, or community authorities. You are solely responsible for
          complying with all laws and/or regulations related to this move of
          firearms under both pertinent regional, state and national laws. The
          transfer of guns is more significantly regulated and restricted, and
          also failure to strictly comply with all such legislation is a
          significant crime and might lead to criminal prosecution. All
          transports of guns, if or not, lease or loan, including private
          trades, ought to proceed via a licensed firearms dealer. Any exception
          to these legislation, such as for example air guns, accessories,
          knives, special antiques, and any weapon components which might well
          not require transport by a licensed trader.
        </p>
        <br /> <br />
        <b>Use of Materials:</b>
        <br />
        <p>
          Any messages or ads that you submit, transmit, or make available for
          viewing on public aspects of the website are going to be medicated
          since it is non-confidential and non-proprietary for your requirements
          personally. You understand and agree that any such ads and messages
          might be used from the website or our affiliates, without any review
          or approval by you, for just about any purpose whatsoever, and also in
          any medium, for example our publishing press, if any other . You grant
          the Site (and our affiliates) the irrevocable right to use and/or edit
          your ads and messages, without any review or approval by you, for
          almost any purpose whatsoever, including, without any limit,
          reproduction, disclosure, transmission, publication, broadcast,
          publishing, and advertising in any media in perpetuity without notice
        ...
        TAll substances on the Site, including without limit, logos, images,
        text, illustrations, sound and video clip documents are protected by
        copyrights, trademarks, service marks, or other proprietary rights which
        are either owned by or certified into this website or owned by other
        parties that are posted on the Site. Materials by the website and from
        some other site owned, controlled, controlled, or licensed from the Site
        might not be duplicated, reproduced, republished, uploaded, posted,
        transmitted, or distributed in any way. In posting content on the Site,
        you grant the Site, and its owners and licensees, the best to use,
        reproduce, distribute, interpret, alter, adapt, publicly perform,
        publicly display, archive and make derivative works out of the submitted
        ...
        you claim has been infringed; 3. A description of where the material
        that you claim is infringing is found on the Site; 4. The title,
        ...
        <b>Privacy Policy:</b>
        <br />
        The Website has made a privacy setting forth how information gathered
        about you is gathered, used and stored. The usage of the Site
        constitutes acknowledgment and agreement with our online privacy policy.
        You further acknowledge and agree that The website may use your private
        information within the way explained in our privacy.
        <br />
        <br />
        <br /> <b>Submitting of Ads:</b>
        <br />
        You know that each time you place an ad with this website or use the
        website, you agree to such Terms. By agreeing to these Conditions, you
        ...
        <br /> <b>Fees:</b>
        <br />
        The Site may impose a commission on the submitting of content material
        in particular regions of the Site. Users sharing Content to fee-based
        areas are liable for such Content and for compliance with such Terms.
        Under no circumstances will the Website supply a refund in case that
        information is removed from fee-based areas for breach of those
        Conditions.
        <br />
        <br />
        <b>Links:</b>
        ...
        <b>Release:</b>
        <br />
        The website assumes no liability for the accuracy, currency,
        completeness or usefulness of information, views, opinions or advice
        from any materials contained on the website. Moreover, it does not
        support any comments or recommendations posted by other people. Any
        advice recorded on the website could be the responsibility of the man or
        ...
        acknowledge, consent and agree that the website will gain access,
        preserve and disclose your account info and Content you upload, post, or
        otherwise make on the Site if needed to do this for legal reasons or
        within a superb faith belief that such access, preservation or
        disclosure is reasonably crucial to:
        <br />
        1. conform to legal process
        <br />
        2. comply with legal requirements imposed by Federal, State or civil
        regulation or authorities
        <br />
        3. enforce these Terms
        <br />
        4. respond to claims that any Content violates the rights of 3rd parties
        <br />
        5. respond to some requests for customer care
        <br />
        6. Safeguard the rights, property or personal safety of the Site, its
        ...
        <p>
          ...
          reserves the right, at its expense, to assume the exclusive defense
          and control of any issue otherwise subject to indemnification from
          you.
          <br />
          Jurisdiction and Choice of Law:
          <br />
          All these Terms are exclusively governed by law. Any disputes arising
          from or in relation to the use of the website or these Conditions
          shall be subject to the jurisdiction of the court in Indore (M.P).
          Disputes must be filed over 1 (1 ) year such dispute arose.
          <br />
          <br />
          <strong>Basic:</strong>
          <br />
          <br />
          These Terms constitute the whole agreement involving you and the Site
          and govern your use of the website, superseding any prior agreements
          between you and the website. You might also be subject to other
          ...
          <br />
          You agree and acknowledge that if any provision of these Terms shall
